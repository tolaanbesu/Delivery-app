...
import { 
  FiFilter, FiHeart, FiStar, FiClock, FiSearch, 
  FiChevronDown, FiMapPin, FiUser, FiMap, FiChevronLeft, FiChevronRight 
} from 'react-icons/fi';

// Import AppStore context
...
const Discovery = () => {
  ...
  return (storeState.restaurants || []).filter(rest => {
    ...
    const matchesCat = activeCategory === 'All' || rest.categoryId === activeCategory.toLowerCase();
    return matchesSearch && matchesCat;
  });
}, [searchQuery, activeCategory, storeState.restaurants]);
  ...
  const featuredStores = (storeState.restaurants || []).filter(r => r.isFeatured);
