...
const Login = ({ setToken }) => {
  ...
  // ✅ CORRECT WAY TO READ APPSTORE
  const [state, dispatch] = useContext(AppContext);
  const { users } = state;

  // Admin comes from same users array (role-based)
  ...
  const handleLogin = (e) => {
    ...
    if (loggedInUser) {
      ...
      // 🔑 OPTIONAL BUT SAFE: sync context
      dispatch({
        type: 'LOGIN_USER',
...
// import { FiMail, FiEye, FiEyeOff, FiArrowRight } from 'react-icons/fi';
// import { useNavigate } from 'react-router-dom';
// import { userData, adminData } from '../../utils/data'; // Import data
