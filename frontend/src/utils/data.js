/* ======================================================
   USERS (users + admin share same model, role-based)
====================================================== */
export const users = [
  {
    id: 1,
...
/* ======================================================
   DELIVERY DRIVER (single active driver for demo)
====================================================== */
export const driver = {
  id: "d1",
  name: "Alex Johnson",
    ...
    items: [
      {
        ...
        price: 8.5,
        img: "https://images.unsplash.com/photo-1573082801974-af29627374f0?w=120",
        active: true
      },
      {
        id: "i2",
        name: "Buffalo Wings",
        description: "12 pcs, Spicy",
        price: 12,
        img: "https://images.unsplash.com/photo-1567620905732-2d1ec7bb7445?w=120",
        active: false
      }
    ]
  },
    ...
    items: [
      {
        ...
        price: 15.5,
        img: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=120",
        active: true
      },
      {
        id: "i4",
        name: "Veggie Burger",
        description: "Quinoa patty, avocado",
        price: 14,
        img: "https://images.unsplash.com/photo-1550547660-d9450f859349?w=120",
        active: true
      }
    ]
  },
    ...
    items: [
      {
        ...
        description: "Warm dark chocolate",
        price: 9,
        img: "https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=120",
        active: true
      }
    ]
  }
...
/* ======================================================
   ORDERS (ONLY source of truth for orders)
   Runtime data lives in AppStore + localStorage
====================================================== */
export const orders = [];
